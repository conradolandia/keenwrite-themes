...
\definefallbackfamily [TextFont] [serif] [Gentium Plus] [
  range={greekandcoptic, spacingmodifierletters, combiningdiacriticalmarks}
  rscale=1.2
]

% Include missing replacement character �
\definefallbackfamily [TextFont] [rm] [Gentium Plus] [range=0FFFD]
...
\definefontfamily [TextFont] [hw] [Niconne] [rscale=1.5]
