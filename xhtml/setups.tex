...
\startxmlsetups xml:xhtml
  ...
  % Meta information (title, author, keywords, copyright, word count, date)
  \xmlsetsetup{\xmldocument}{head}{xml:meta}
  \xmlsetsetup{\xmldocument}{title}{xml:title}
  \xmlsetsetup{\xmldocument}{meta[@name='author']}{xml:author}
  \xmlsetsetup{\xmldocument}{meta[@name='pseudonym']}{xml:pseudonym}
  \xmlsetsetup{\xmldocument}{meta[@name='count']}{xml:wordcount}
